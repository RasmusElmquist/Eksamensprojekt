//Grunden til jeg har valgt at bruge "post draw" er fordi den er meget ens med step evernts. 
//Så når noget sker i rummet sker for alle objekter i spillet.
//Det jeg har gjort her er, det samme som vi gjorde med vores player. At der er en kolision.
